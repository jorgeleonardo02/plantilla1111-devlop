...
import Plantilla.apirest.controllers.CategoriaRestController;
...
public class CommonRestController<E, S extends ICommonService<E>> {
	...
	// El método listarElementos() método obtiene todos los elementos<E> registrados
	// en base de datos
	// - Parámetros: ninguno
	...
	public List<E> listarElementos() {
		logger.debug("Recibida solicitud para listar elementos.");
		return iService.listarElementos();
	}

	// El método listarElementosPaginado permite listar los elementos usando
	// paginación
	...
	// - Retorna: Un ResposeEntity con el resultado del proceso (un error o el
	// Elemento creado)
	...
	// El método eliminarElemento obtiene el elemento con el ID especificado en la
	// URL para luego
	// eliminar el elemento de la base de datos
	// Parámetros:
	// - El ID del elemento a eliminar (URL de la petición)
	// Retorna: Un ResponseEntity con la respuesta de la petición (el mensaje de
	// éxito o error)
	...
	public ResponseEntity<?> eliminarElemento(@PathVariable Long id) {
		...
		mapa.put("mensaje", "Se elimino registro, ¡exitoso!");
		return new ResponseEntity<>(mapa, HttpStatus.OK);
	}
 ...
 * protected S iService;
 * 
 * // El método listarElementos() método obtiene todos los elementos<E>
 * registrados
 * // en base de datos
 * // - Parámetros: ninguno
 * // - Retorna: Una lista de Elementos de la clase "E"
 ...
 * @GetMapping("/pagina")
 * public ResponseEntity<?> listarElementosPaginado(Pageable paginador) {
 * Pageable pag = PageRequest.of(paginador.getPageNumber(),
 ...
 * 
 * // armo el mapa para agregarlo al ResponseEntity
 * mapa.put("mensaje", "Ha ocurrido un error al obtener el elemento con ID " +
 * id);
 * mapa.put("error", e.getMessage() + ": " + e.getMostSpecificCause());
 * return new ResponseEntity<Map<String, Object>>(mapa,
 * HttpStatus.INTERNAL_SERVER_ERROR);
 * }
 * 
 * if (entity == null) {
 * mapa.put("mensaje", "El elemento con ID " + id +
 ...
 * }
 * 
 * // El método eliminarElemento obtiene el elemento con el ID especificado en
 * la
 * // URL para luego
 * // eliminar el elemento de la base de datos
 * // Parámetros:
