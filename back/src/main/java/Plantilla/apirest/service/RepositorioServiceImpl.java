...
public class RepositorioServiceImpl implements IRepositorioService {
	...
	private final static String REPOSITORIO_CARPETA = "almacenamiento archivos"/*
																				 * "C:/Users/jorgeleonardo/Desktop/Plantilla proyecto/plantilla1 NM Front/src/app/cuerpo/almacenamiento archivos"
																				 *//*
																					 * "carpetaAlmacenamiento"
																					 *//*
																						 * "C:/Users/jorgeleonardo/Desktop/Plantilla proyecto/NM back/almacenamiento archivos"
																						 */;
	private final Logger log = LoggerFactory.getLogger(getClass());

	/**
	 * Este método obtiene el Path absoluto para la carpeta especificada en la
	 * variable "REPOSITORIO_CARPETA"
	 * agregando en la ruta el nombre del archivo especificado en la variable
	 * "nombreArchivo".
	 * Este método se convierte en una método auxiliar que va a ser usado por los
	 * diferentes método de esta clase.
	 *
	...
	public Path getPath(String nombreArchivo) {
		log.info("rootAbsolutPath:" + Paths.get(REPOSITORIO_CARPETA).resolve(nombreArchivo).toAbsolutePath());
		return Paths.get(REPOSITORIO_CARPETA).resolve(nombreArchivo).toAbsolutePath();
	}

	/**
	 * Este método obtiene el archivo de acuerdo a su nombre (indicado en la
	 * variable nombreFoto)
	 *
	...
	public Resource obtenerFoto(String nombreFoto) throws MalformedURLException {
		...
		log.info("pathFoto En Obtener Foto:" + pathFoto);
	...
	/**
	 * Este método copia el archivo que se indica como parámetro en la ubicación
	 * especificada
	 *
	...
	public String copiarfotoEnCarpeta(MultipartFile archivo) throws IOException {
		...
		String nombreUnicoArchivo = UUID.randomUUID().toString() + "_" + archivo.getOriginalFilename(); // genero un
																										// nombre único
																										// para el
																										// archivo
